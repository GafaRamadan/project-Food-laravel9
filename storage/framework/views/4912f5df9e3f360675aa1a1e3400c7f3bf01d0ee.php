                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <form method="POST" action="<?php echo e(route('reservations.store.step.two')); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mt-1">
                                        <select id="table_id" name="table_id"
                                            ...
                                            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($table->id); ?>" <?php if($table->id): echo 'selected'; endif; ?>>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Final-odc\resources\views/reservations/step-two.blade.php ENDPATH**/ ?>